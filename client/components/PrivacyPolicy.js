  ...
  render() {
    return (
      <div>
        ...
        <p>Effective date: June 16, 2019</p>

        <p>
          Mnemosphere ("us", "we", or "our") operates the
          https://mnemosphere.herokuapp.com website (hereinafter referred to as
          the "Service").
        </p>
        ...
        <p>
          ...
          https://mnemosphere.herokuapp.com
        </p>
        ...
        <ul>
          <li>
            ...
            <p>
              Service is the https://mnemosphere.herokuapp.com website operated
              by Mnemosphere
            </p>
          </li>
          <li>
        ...
        <h2>Use of Data</h2>
        <p>Mnemosphere uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          If you are from the European Economic Area (EEA), Mnemosphere legal
        ...
        <p>Mnemosphere may process your Personal Data because:</p>
        <ul>
        ...
        <p>
          Mnemosphere will retain your Personal Data only for as long as is
        ...
        <p>
          Mnemosphere will also retain Usage Data for internal analysis
        ...
        <p>
          Mnemosphere will take all the steps reasonably necessary to ensure
        ...
        <p>
          Under certain circumstances, Mnemosphere may be required to disclose
        ...
        <p>
          Mnemosphere may disclose your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Mnemosphere</li>
          <li>
        ...
        <p>
          ...
          certain data protection rights. Mnemosphere aims to take reasonable
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              right to withdraw your consent at any time where Mnemosphere
        ...
        <ul>
          <li>By email: alexcwaite@gmail.com</li>
        </ul>
      </div>
    );
  }
